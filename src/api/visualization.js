    ...
    eventVisualization: {
        ...
        params: ({ nameProp }) => ({
            fields: [
                ...
                'programStage[id,displayName~rename(name),executionDateLabel,displayExecutionDateLabel,dueDateLabel,displayDueDateLabel,hideDueDate,repeatable]',
                `programDimensions[id,${nameProp}~rename(name),enrollmentDateLabel,incidentDateLabel,programType,displayIncidentDate,displayEnrollmentDateLabel,displayIncidentDateLabel,programStages[id,${nameProp}~rename(name),repeatable,hideDueDate,executionDateLabel,displayExecutionDateLabel,dueDateLabel,displayDueDateLabel]]`,
                'access',
                'href',
